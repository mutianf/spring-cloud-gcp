...
/**
 * Alias for {@link BigtablePartTreeQuery} supporting alternative naming convention.
 *
 * @param <T> the domain type
 */
public class PartTreeBigtableQuery<T> extends BigtablePartTreeQuery<T> {

  public PartTreeBigtableQuery(
      BigtableQueryMethod queryMethod,
      BigtableOperations bigtableOperations,
      BigtableMappingContext mappingContext) {
    super(queryMethod, bigtableOperations, mappingContext);
  }
}
