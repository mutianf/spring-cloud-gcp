 ...
 * com.google.cloud.spring.data.bigtable.repository.config.EnableBigtableRepositories}.
 */
@AutoConfiguration
@ConditionalOnClass(BigtableRepository.class)
@ConditionalOnMissingBean({
  BigtableRepositoryFactoryBean.class,
  BigtableRepositoryConfigurationExtension.class
})
@ConditionalOnProperty(value = "spring.cloud.gcp.bigtable.enabled", matchIfMissing = true)
@Import({BigtableRepositoriesAutoConfigureRegistrar.class})
@AutoConfigureBefore(GcpBigtableAutoConfiguration.class)
public class BigtableRepositoriesAutoConfiguration {}
